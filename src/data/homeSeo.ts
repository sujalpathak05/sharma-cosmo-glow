...
export const homeKeywordClusters: SeoKeywordCluster[] = [
  {
    ...
    description:
      "These are the location-driven phrases patients often use when they are actively looking for a nearby clinic in Noida or Delhi NCR.",
    keywords: [
      "skin clinic in Noida",
      "cosmetic clinic in Noida",
  ...
  },
  {
    ...
    description:
      "Sharma Cosmo Clinic is an advanced skin care clinic led by an experienced dermatologist offering a full range of cosmetic procedures and skin treatments.",
    keywords: [
      "advanced skin care clinic",
      "experienced dermatologist",
      "cosmetic procedures in Noida",
...
export const homeFaqs: SeoFaq[] = [
  ...
  {
    question: "How much does PRP treatment cost in Noida?",
    answer:
      "PRP hair treatment cost in Noida at Sharma Cosmo Clinic depends on the number of sessions required, scalp condition, and the treatment plan recommended after evaluation. Most patients require multiple sessions spaced over weeks. The clinic provides transparent pricing after the initial consultation so you understand the full commitment before starting.",
  },
];
