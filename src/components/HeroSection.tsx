  ...
  return (
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden bg-charcoal">
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Dermatologist consultation in Noida - Sharma Cosmo Clinic Skin Hair and Cosmetic Treatment Center"
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              >
                ...
                Skin &amp; Cosmetic Clinic in Noida serving Delhi NCR
              </div>
              ...
              <div className="overflow-hidden mt-6">
                ...
                >
                  Expert dermatology treatments and aesthetic procedures at Sharma Cosmo Clinic Noida.
                  Acne treatment, PRP hair treatment, laser hair removal, chemical peels, and anti-aging
                  care — all doctor-led by Dr. Vishikant Sharma from day one.
                </p>
              </div>
