...
const hairServices = [
  { icon: Wind, title: "PRP Hair Treatment", slug: "prp-hair-treatment", desc: "Scalp-focused planning for hair fall, early thinning, and weak follicles with PRP, supportive medical care, and long-term maintenance guidance.", detail: "Hair treatment starts with scalp and trigger assessment so procedures like PRP are recommended only when they are likely to help." },
  { icon: Wind, title: "Alopecia Treatment", slug: "alopecia-treatment", desc: "Focused evaluation for patchy hair loss, thinning patterns, scalp inflammation, and shedding with medical and procedure-based options where suitable.", detail: "Alopecia care begins with identifying the type of hair loss so medicines, scalp care, PRP, or supportive treatments are chosen appropriately." },
];

const skinServices = [
  { icon: Sparkles, title: "Acne and Skin Treatment", slug: "acne-and-skin-treatment", desc: "Doctor-led care for active acne, acne marks, pigmentation, dullness, and uneven skin tone with routines that respect your skin barrier.", detail: "Plans may include consultation, home-care correction, clinic procedures, and follow-up that matches your skin type and recovery comfort." },
  { icon: Droplets, title: "Chemical Peel Treatment", slug: "chemical-peel-treatment", desc: "Targeted peel planning for tan, acne marks, oil control, texture, and superficial pigmentation with gradual, safe improvement.", detail: "Each peel is selected according to sensitivity, pigment risk, and the exact concern being treated instead of using a one-size-fits-all protocol." },
  { icon: Droplets, title: "Psoriasis Treatment", slug: "psoriasis-treatment", desc: "Assessment-led care for psoriasis flare-ups, scaling, redness, and itch with medical treatment, trigger review, and maintenance support.", detail: "Treatment is tailored to severity, affected areas, triggers, and lifestyle factors so flare control and long-term skin comfort stay realistic." },
  { icon: Sparkles, title: "Vitiligo Treatment", slug: "vitiligo-treatment", desc: "Personalized care for white patches, color change, and progression monitoring with counseling, medical therapy, and follow-up planning.", detail: "Vitiligo treatment is planned around activity, site, spread, and response so patients know what improvement can reasonably look like over time." },
  { icon: Zap, title: "Laser Hair Removal", slug: "laser-hair-removal", desc: "Laser-based hair reduction and skin-focused laser planning for patients who want smoother results and less dependence on frequent waxing.", detail: "Suitability is assessed according to skin tone, hair thickness, target area, and the number of sessions needed for consistent reduction." },
  { icon: Clock, title: "Botox and Anti-Aging Treatment", slug: "botox-and-anti-aging-treatment", desc: "Natural-looking anti-aging planning for early lines, tired skin, texture changes, and preventive aesthetic care.", detail: "Botox, peels, hydration support, and skin-quality treatments are recommended conservatively to keep results refined and facial expressions balanced." },
  { icon: Scissors, title: "Aesthetic Consultations", slug: "aesthetic-consultations", desc: "Personalized consultations for glow goals, event preparation, pigmentation correction, and doctor-guided cosmetic treatment planning.", detail: "Every recommendation is explained in clear terms so you understand the expected benefit, downtime, and maintenance before you proceed." },
];
      ...
      <div className="section-container">
        <div className={`text-center mb-16 transition-all duration-800 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-body max-w-2xl mx-auto">
            From acne treatment in Noida and chemical peel treatment to PRP hair treatment in Noida,
            laser hair removal in Noida, pigmentation treatment, psoriasis, alopecia, vitiligo, and
            anti-aging care, every service is planned around clinical suitability and realistic outcomes.
          </p>
        </div>
          ...
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>{isExpanded ? "Hide Details" : "Quick Look"}</span>
                  <ArrowRight
                    size={16}
                ...
                <Link
                  ...
                  className="mt-3 flex items-center gap-2 font-body text-sm font-semibold text-foreground transition-colors hover:text-primary"
                >
