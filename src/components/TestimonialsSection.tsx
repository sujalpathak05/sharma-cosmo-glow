      ...
      <div className="section-container">
        <div className={`text-center mb-16 transition-all duration-800 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-body max-w-2xl mx-auto mb-6">
            Real experiences from patients in Noida and Delhi NCR who trusted us for skin treatments,
            acne care, PRP hair treatment, laser hair removal, and cosmetic procedures.
          </p>
          <button
